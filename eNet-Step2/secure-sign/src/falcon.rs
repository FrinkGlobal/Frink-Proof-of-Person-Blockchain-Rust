...
extern "C" {
    pub fn falcon_vrfy_start(fv: *mut falcon_vrfy, r: *const ::std::os::raw::c_void, rlen: usize);
}
extern "C" {
...
extern "C" {
    pub fn falcon_keygen_max_privkey_size(fk: *mut falcon_keygen) -> usize;
}
extern "C" {
    pub fn falcon_keygen_max_pubkey_size(fk: *mut falcon_keygen) -> usize;
}
extern "C" {
